...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
   ...
   <div class="container col-11">
    ...
    if(isset($_POST['cari'])){
      $cari = $_POST['search'];
      $qry_member = mysqli_query($konn,"select * from member where nama like'%".$cari."%'")or die (mysqli_error($konn));
    }else{
        $qry_member = mysqli_query($konn,"select * from member")or die (mysqli_error($konn));
    }
                ...
                <div class="modal-body">
                    ...
                    <option value="">Pilih outlet</option>
                        <?php
                            ...
                            $tempat_outlet = $outlet['nama_outlet'];

                        ?>
                            <option value="<?php echo $id_outlet?>"><?php echo $tempat_outlet?></option>
                        <?php
                    }
                    ?>
                    </select>
            ...
            <div class="modal-dialog" role="document">
                ...
                <form action="" method="post">
                    ...
                    <select name="gender" id="" class="form-control">
                        <option value="<?php echo $data_pelanggan['jenis_kelamin']?>"><?php echo $data_pelanggan['jenis_kelamin']?></option>
...
// Ini Buat edit 
                            ...
                            if(empty($nama)){
                                ...
                                echo "<script>alert('jenis kelamin tidak boleh kosong');location.href='tampil_pelanggan.php';</script>";
                                ...
                                echo "<script>alert('telpon tidak boleh kosong');location.href='tampil_pelanggan.php';</script>";
                                    ...
                                    $update=mysqli_query($konn,"update member set nama='".$nama."',alamat='".$alamat."',jenis_kelamin='".$jenis_kelamin."',tlp='".$tlp."'where id = '".$id."'") or die(mysqli_error($konn));
